#!/usr/bin/env python3
"""
YOLOv8n multicore benchmark — runs a single YOLOv8n model across all 3 NPU cores
for maximum throughput on a live video stream.

Architecture:
  capture → preprocess → SharedQueue (drop-oldest)
